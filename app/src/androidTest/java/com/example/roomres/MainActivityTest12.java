...
public class MainActivityTest12 {
    ...
    public void mainActivityTest12() {
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.email_Edittext),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("fisnik@aslani.eu"), closeSoftKeyboard());
        appCompatEditText.check(matches(withText("fisnik@aslani.eu")));
        ...
        appCompatEditText2.check(matches(withText("1234567")));
